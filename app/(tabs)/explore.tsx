          ...
          <SettingRow
            ...
            rightComponent={
              <Switch
                ...
                onValueChange={(value) =>
                  updateSetting("performanceMonitoring", value)
                }
                trackColor={{ false: "#767577", true: "#007AFF" }}
                thumbColor={
                  settings.performanceMonitoring ? "#FFFFFF" : "#f4f3f4"
                }
              />
            }
          />
          ...
          <SettingRow
            ...
            rightComponent={
              <Switch
                ...
                onValueChange={(value) =>
                  updateSetting("userScriptsEnabled", value)
                }
                trackColor={{ false: "#767577", true: "#007AFF" }}
          ...
          <SettingRow
            ...
            rightComponent={
              <Switch
                ...
                onValueChange={(value) =>
                  updateSetting("autoSaveHistory", value)
                }
                trackColor={{ false: "#767577", true: "#007AFF" }}
          ...
          <SettingRow
            ...
            rightComponent={
              <Switch
                ...
                onValueChange={(value) =>
                  updateSetting("javascriptEnabled", value)
                }
                trackColor={{ false: "#767577", true: "#007AFF" }}
          ...
          <SettingRow
            ...
            rightComponent={
              <Switch
                ...
                onValueChange={(value) =>
                  updateSetting("adBlockEnabled", value)
                }
                trackColor={{ false: "#767577", true: "#007AFF" }}
              ...
              <View style={styles.statusRow}>
                <View
                  style={[
                    ...
                    {
                      backgroundColor:
                        mcpStats?.connectedServers > 0 ? "#4CAF50" : "#8E8E93",
                    },
                  ]}
                >
                  <Text style={styles.statusText}>
